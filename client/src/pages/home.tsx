    ...
    queryFn: async ({ queryKey }) => {
      ...
      if (typeof window !== 'undefined' && !window.location.href.includes('localhost') && !window.location.href.includes('replit.dev') && !window.location.href.includes('127.0.0.1')) {
        try {
          ...
          const response = await fetch('https://admin-backend-eckjz4xit-jeremys-projects-0f68a4ab.vercel.app/api/public/vehicles', { headers });
          if (response.ok) {
    ...
    queryFn: async () => {
      ...
      if (typeof window !== 'undefined' && !window.location.href.includes('localhost') && !window.location.href.includes('replit.dev') && !window.location.href.includes('127.0.0.1')) {
        try {
          ...
          const response = await fetch('https://admin-backend-eckjz4xit-jeremys-projects-0f68a4ab.vercel.app/api/public/vehicles/featured', { headers });
          if (response.ok) {
